...
public class MainWindow extends JFrame {
	...
	public MainWindow() {
		...
		titleImage = new ImageIcon(getClass().getResource(
				"/images/title.png"));

		titleGaloLabel = new JLabel(titleImage);
		...
		playerImage = new ImageIcon(getClass().getResource("/images/O.png"));
		computerImage = new ImageIcon(getClass().getResource("/images/X.png"));
	...
	private void configureStartButton(final JButton start,
		...
		start.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent a) {
				...
				Board board = new Board("O", true, true);
				mainWindow.dispose();
